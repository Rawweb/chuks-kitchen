    ...
    <section className='min-h-screen bg-soft-gray'>
      <div className='grid min-h-screen md:grid-cols-2'>
        ...
        <div className='relative hidden md:block'>
          ...
          {/* Orange overlay to match the design tone */}
          ...
          <div className='w-full max-w-md'>
            ...
            <form className='mt-7 space-y-4'>
              ...
              <div>
                ...
                <div className='flex items-center gap-2 rounded-md border border-gray-300 bg-white px-3 py-3'>
                  <Phone size={16} className='text-dark-gray' />
                  <input
                    id='phone'
                    type='tel'
                    placeholder='08068226614'
                    className='w-full bg-transparent text-sm text-charcoal outline-none'
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className='flex items-center gap-2 rounded-md border border-primary-blue bg-white px-3 py-3'>
